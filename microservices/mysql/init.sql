...
-- Crea las 6 bases de datos independientes (una por microservicio)
...
CREATE DATABASE IF NOT EXISTS iobuild_profiles CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
