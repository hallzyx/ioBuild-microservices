namespace IoBuild.IAM.Domain.Model.Entities;

/// <summary>
/// Outbox row for the IAM service (ADR-8b, ADR-E).
/// Mirrors IoBuild.Projects.Domain.Model.Entities.OutboxMessage exactly.
///
