...
```
Given a DeviceCreatedEvent was consumed and DeviceProjection now has 1 row for DeviceId = X
...
And a DeviceDeletedEvent was consumed, removing or deactivating DeviceId = X
When a GET request is made to the Analytics device-count endpoint
